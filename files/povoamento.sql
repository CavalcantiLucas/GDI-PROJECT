...
INSERT INTO Endereco(cep, rua)
    VALUES ('57071182', 'Rua Nova Vida');

INSERT INTO Endereco(cep, rua)
    VALUES ('69050510', 'Rua Portugal');

INSERT INTO Endereco(cep, rua)
    VALUES ('13274350', 'Avenida Doutor Altino Gouveia');

INSERT INTO Endereco(cep, rua)
    VALUES ('79004240', 'Rua Calil José Domingos');

INSERT INTO Endereco(cep, rua)
    VALUES ('79017042', 'Rua Alfredo Borba');

INSERT INTO Endereco(cep, rua)
    VALUES ('69908650', 'Avenida Getúlio Vargas');

INSERT INTO Endereco(cep, rua)
    VALUES ('23092490', 'Rua São Bento do Sul');

INSERT INTO Endereco(cep, rua)
    VALUES ('51350151', '1ª Travessa Rio Jaratuba');

INSERT INTO Endereco(cep, rua)
    VALUES ('79065293', 'Travessa Mirindiba');

INSERT INTO Endereco(cep, rua)
    VALUES ('58416605', 'Rua José Sebastião da Silva');

INSERT INTO Endereco(cep, rua)
    VALUES ('74971460', 'Travessa 1');

INSERT INTO Endereco(cep, rua)
    VALUES ('69901255', 'Estrada Particular');

INSERT INTO Endereco(cep, rua)
    VALUES ('75143250', 'Rua Afrânio Peixoto');

INSERT INTO Endereco(cep, rua)
    VALUES ('60831160', 'Rua Lourdes Vidal Alves');

INSERT INTO Endereco(cep, rua)
    VALUES ('85304390', 'Rua das Canafístulas');

INSERT INTO Endereco(cep, rua)
    VALUES ('58420430', 'Rua Alaíde Leandro Sobreira');

INSERT INTO Endereco(cep, rua)
    VALUES ('19067100', 'Rua Santa Pavezi Rubim');

INSERT INTO Endereco(cep, rua)
    VALUES ('65632660', 'Rua Três');

INSERT INTO Endereco(cep, rua)
    VALUES ('89218055', 'Rua Blumenau');

INSERT INTO Endereco(cep, rua)
    VALUES ('37048730', 'Rua Vereador Paulo Valias');

INSERT INTO Endereco(cep, rua)
    VALUES ('69908200', 'Beco Neutel Maia');

INSERT INTO Endereco(cep, rua)
    VALUES ('58059744', 'Rua Flor de Íris');

INSERT INTO Endereco(cep, rua)
    VALUES ('78142258', 'Rua Sete');

INSERT INTO Endereco(cep, rua)
    VALUES ('77827240', 'Rua dos Bacuris');

INSERT INTO Endereco(cep, rua)
    VALUES ('30421335', 'Rua Gama Cerqueira');

INSERT INTO Endereco(cep, rua)
    VALUES ('95040230', 'Rua Doutor Rômulo Carbone');

INSERT INTO Endereco(cep, rua)
    VALUES ('54100640', 'Rua Maurício de Nassau');

INSERT INTO Endereco(cep, rua)
    VALUES ('83060020', 'Rua Alcides Munhoz Neto');
...
INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('95438868069', 'Thiago Pérez Gomes', 'M', '33', '69050510', 'Ap 302', '64');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('95068505005', 'Sara Maria da Carvalheira', 'F', '38', '13274350', NULL, '26');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('42777797005', 'Raissa Heimann', 'F', '29', '79004240', 'Ap 2201', '770');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('32798587042', 'Lucas Gabriel Barbosa', 'M', '26', '79017042', 'Ap 1501', '33');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('99942745033', 'Lucas Oliveira Cavalcanti', 'M', '30', '54505390', NULL, '322');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('61888835044', 'João Lucas Alves', 'M', '34', '69908650', NULL, '89');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('99518963088', 'Bruna Alves W. Siqueira', 'F', '35', '23092490', 'Ap 1202', '90');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('29014744030', 'Luíza Coutinho Brasil', 'F', '36', '51350151', 'Ap 501', '326');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('16790533028', 'Patricia Ismael de Carvalho', 'F', '50', '79065293', 'Ap 701', '215');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('35170942001', 'Rodrigo Mesel Lobo de Oliveira', 'M', '33', '58416605', NULL, '42');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('66559107060', 'Matheus Frej Lemos C.', 'M', '62', '74971460', 'Ap 101', '800');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('78366263002', 'Alexandre Ottoni', 'M', '45', '69901255', NULL, '192');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('96627054060', 'Deive Pazos', 'M', '47', '75143250', NULL, '193');
...
INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('94044687544', 'Lucas Gabriel R. de Melo', 'M', '25', '19067100', 'Ap 2002', '471');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('34864572097', 'Ana Carla Albuquerque', 'F', '28', '65632660', 'Ap 904', '63');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('42824439602', 'Gabriel Barbosa Almeida', 'M', '26', '89218055', 'Ap 3001', '1226');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('96382647217', 'Maria Fernanda O. da Silva', 'F', '36', '37048730', 'Ap 1002', '687');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('17932577527', 'Ivete Maria D. Sangalo', 'F', '50', '69908200', NULL, '309');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('38612505780', 'Larissa de Macedo Machado', 'F', '29', '58059744', NULL, '12');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('93405446929', 'Larissa Manoela Joaquina', 'F', '23', '78142258', 'Ap 2401', '700');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('26744842684', 'Pogba Blanc do Jardim dos Arcos', 'M', '35', '77827240', 'Ap 1601', '19');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('77648271427', 'Ada Heimann', 'F', '30', '30421335', NULL, '991');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('62538131103', 'José Arantes do Nascimento', 'M', '81', '95040230', NULL, '582');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('88634284255', 'Carlos Eduardo dos S. Galvão Bueno', 'M', '72', '54100640', 'Ap 201', '822');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('62982197499', 'José Fernando Fumagali', 'M', '44', '83060020', 'Ap 1901', '270');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('18956810818', 'Simone Nassau Tebet', 'F', '31', '94853810', 'Ap 503', '90');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('06027847514', 'Maria Osmarina da Silva', 'F', '28', '64853810', NULL, '26');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('85997072215', 'Daniel Negreanu', 'M', '48', '94853813', 'Ap 4101', '345');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('53885643715', 'Ronaldo Luís Nazário de Lima', 'M', '45', '94803817', NULL, '555');

INSERT INTO Pessoa(cpf, nome, sexo, idade, cep_endereco, complemento, numero)
    VALUES ('45836067376', 'Neymar da Silva Santos Júnior', 'M', '30', '94813811', 'Ap 202', '616');
...
INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('19321816283', 3000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('94044687544', 600);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('34864572097', 5000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('42824439602', 10000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('96382647217', 100);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('17932577527', 1000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('38612505780', 300);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('93405446929', 50000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('26744842684', 500);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('77648271427', 2500);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('62538131103', 2000);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('88634284255', 300);

INSERT INTO Jogador(cpf_jogador, carteira)
    VALUES ('62982197499', 7500);
...
INSERT INTO Casa(cnpj, nome, saldo)
    VALUES ('07829772000180', 'The Wild Jack', 4121000);
...
INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Supervisor', '40658419000150', 6249);

INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Caixa', '40658419000150', 3254);

-- Casa 2
INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Dealer', '07829772000180', 5876);
    
INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Supervisor', '07829772000180', 10095);

INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Caixa', '07829772000180', 4320);

-- Casa 3
INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Dealer', '89619720000143', 3587);

INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Supervisor', '89619720000143', 5213);

INSERT INTO Emprego(cargo, cnpj_casa, salario)
    VALUES ('Caixa', '89619720000143', 2400);
...
INSERT INTO Funcionario(cpf_funcionario, cargo_funcionario, cnpj_casa, cpf_supervisor)
    VALUES ('51871590035', 'Dealer', '40658419000150',  '95068505005');
...
INSERT INTO Funcionario(cpf_funcionario, cargo_funcionario, cnpj_casa, cpf_supervisor)
    VALUES ('61888835044', 'Caixa', '07829772000180',  '16790533028');

INSERT INTO Funcionario(cpf_funcionario, cargo_funcionario, cnpj_casa, cpf_supervisor)
    VALUES ('99518963088', 'Dealer', '07829772000180',  '16790533028');
...
INSERT INTO Funcionario(cpf_funcionario, cargo_funcionario, cnpj_casa, cpf_supervisor)
    VALUES ('66559107060', 'Dealer', '89619720000143',  '49869393004');

INSERT INTO Funcionario(cpf_funcionario, cargo_funcionario, cnpj_casa, cpf_supervisor)
    VALUES ('78366263002', 'Dealer', '89619720000143',  '49869393004');
...
INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('40658419000150','Vermelho',5);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('40658419000150','Azul',10);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('40658419000150','Verde',50);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('40658419000150','Amarelo',100);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('40658419000150','Preto',1000);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Amarelo',1);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Rosa',10);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Vermelho',100);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Azul',500);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Preto',1000);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('07829772000180','Verde',5000);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('89619720000143','Preto',1);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('89619720000143','Rosa',10);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('89619720000143','Vermelho',100);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('89619720000143','Amarelo',500);

INSERT INTO Ficha_casa (cnpj_casa, cor, valor)
    VALUES('89619720000143','Azul',1000);
...
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('51871590035', '(81)9499-1316');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('95438868069', '(47)3972-9080');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('95438868069', '(47)3142-1485');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('95068505005', '(63)2826-7292');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('95068505005', '(27)2703-8803');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('42777797005', '(89)2360-5288');

INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('42777797005', '(98)3280-8086');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('32798587042', '(85)2061-8663');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('32798587042', '(95)2708-2183');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('99942745033', '(66)2257-3548');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('61888835044', '(83)2674-1757');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('99518963088', '(97)3681-1333');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('29014744030', '(61)2723-7967');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('16790533028', '(68)2871-1567');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('35170942001', '(63)3077-8153');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('66559107060', '(84)3323-9848');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('78366263002', '(49)2665-5117');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('96627054060', '(85)3644-4381');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('49869393004', '(82)3123-1501');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('55566621111', '(83)2023-1391');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('19321816283', '(85)2756-2416');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('94044687544', '(67)3638-7834');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('34864572097', '(98)3181-5805');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('42824439602', '(68)3415-5355');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('96382647217', '(83)2025-1552');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('17932577527', '(83)2362-4256');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('38612505780', '(65)3117-9564');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('93405446929', '(24)2678-6881');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('26744842684', '(18)2998-3706');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('77648271427', '(61)3150-7096');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('62538131103', '(62)3516-0550');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('88634284255', '(63)2433-8382');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('62982197499', '(79)3823-5373');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('18956810818', '(65)2761-2123');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('06027847514', '(12)3413-5118');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('85997072215', '(88)2965-0260');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('53885643715', '(32)3458-4154');
    
INSERT INTO Numero_Telefone(cpf_pessoa, telefone)
    VALUES ('45836067376', '(22)2076-2428');
...
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '1' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '2' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '3' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '4' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '5' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '6' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '7' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '40658419000150', '8' );
    
    

INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '1' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '2' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '3' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '4' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '5' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '6' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '7' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '07829772000180', '8' );
    
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '1' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '2' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '3' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '4' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '5' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '6' );
    
INSERT INTO Contem(cnpj_casa, jogo_id)
    VALUES ( '89619720000143', '7' );
